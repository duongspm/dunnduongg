...
function NavBlog(){
    ...
    const headerClass = scrollPosition > 0 ? 'scrolled' : '';
            ...
            <div className="nav">
                <div className="search">
                    <div className="search__left">
                        <div className="search__logo2"></div>
                        <div className="search__logo">
                            <a href="https://duongspm.github.io" target="_blank">DUO</a>
                        </div>
                        <div class="searchbar">
                    ...
                    <div className="search__right">
                        <div className="blog__header">
                            <p>🌠 I sell takeaway coffee. Would you like to support me?  <a className="buynow" href="https://ddcoffee-release.vercel.app/" target="_blank"> Buy Now 
